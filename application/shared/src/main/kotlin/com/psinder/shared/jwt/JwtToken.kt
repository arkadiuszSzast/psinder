...
import com.psinder.shared.validation.rules.isValidJwt
...
value class JwtToken private constructor(val token: String) : Validatable<JwtToken> {
    companion object {
        ...
        val validator = Validation<JwtToken> {
            JwtToken::token {
    ...
    fun getSubjectUnsafe(): String? = JWT.decode(token).subject

    override val validator: Validation<JwtToken>
        get() = JwtToken.validator
}
