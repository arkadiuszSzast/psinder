...
internal class FindAccountByEmailQueryHandler(private val accountRepository: com.psinder.account.AccountRepository) :
    ...
    override suspend fun handleAsync(query: FindAccountByEmailQuery) = runBlocking {
        ...
        FindAccountByEmailQueryResult(optAccount.map { com.psinder.account.AccountDto.fromAccount(it) })
    }
}
