...
@Serializable
data class DogPairFoundEvent(
    @Contextual val dogId: Id<DogProfileDto>,
    @Contextual val pairDogId: Id<DogProfileDto>
) : DomainEvent {
    ...
    override val eventName = DogPairFoundEvent.eventName

    override val aggregateType: AggregateType = dogAggregateType

    companion object {
        val eventName: EventName = EventName("pair-found")
